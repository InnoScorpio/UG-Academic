...
#define G4 GLfloat mat_diffuse0[] = { 1.,.9,.0, 1.0 };
...
void main(int argc, char **argv)
{
	...
	glutCreateWindow("Dr. Tannouri's walking robot visualization");
	init();
