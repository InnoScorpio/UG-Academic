...
GLfloat mat_diffuse1[] = { 1.,.5, 0., 1. }; //red

GLfloat mat_diffuse2[] = { 1.,.5, 0., 1. }; //blue

GLfloat mat_diffuse3[] = { 0.,0.,1., .5 }; //blue

GLfloat mat_diffuse4[] = { 1.,1.,0., .5 }; //sky

GLfloat mat_diffuse5[] = { 1.,1.,1., .5 }; //violet

GLfloat mat_diffuse6[] = { 0.,1.,0., .0 }; //brown
...
GLfloat light1_position[] = { -300.,200.,-260., .0 };

GLfloat light2_position[] = { 300., 200., 260., .0 };

GLfloat light3_position[] = { 200., 100., 260., 0.0 };

GLfloat light4_position[] = { -200., 100., 150., 0.0 };

GLfloat light5_position[] = { 1000., 100., 260., .0 };

GLfloat light6_position[] = { -100., 100.,-260., .0 };
...
void drawGrid() { for (int i = -20; i < 20; i++) for (int j = -20; j < 20; j++) { M T i*d, j *d, -100.); L7 Scub d - 1.); l7 m } }
...
void spinDisplay() { if (ang < 360.)ang += .3; else ang = 0.;  x += speed * cos(ha / 57.3); z += speed * sin(ha / 57.3);  glutPostRedisplay(); }
...

{
	...
	glutCreateWindow("Jose's Project");
	init();
