...
to setup-5
  if (who = 1) [ set x -1 set y 0 ]
  if (who = 2) [ set x  0 set y 0 ]
  if (who = 3) [ set x  1 set y 0 ]
  if (who = 4) [ set x  2 set y 0 ]
  if (who = 5) [ set x  3 set y 0 ]
end
