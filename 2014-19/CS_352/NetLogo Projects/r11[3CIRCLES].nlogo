...
to setup-piece8
  setup-10 set color pink
 setxy
 ([xcor] of turtle 0) + x
 ([ycor] of turtle 0) + y
end

to setup-piece9  ;;T-shaped
  setup-11 set color magenta
  setxy
   ([xcor] of turtle 0) + x
   ([ycor] of turtle 0) + y
end

to setup-piece10  ;; 4 Box
  setup-12 set color orange
  setxy
  ([xcor] of turtle 0) + x
  ([ycor] of turtle 0) + y
end
...
to setup-10
  if (who = 1) [ set x  2 set y  2 ]
  if (who = 2) [ set x  2 set y  1 ]
  if (who = 3) [ set x  1 set y  1 ]
  if (who = 4) [ set x  0 set y  1 ]
end


to setup-11 ;5 T-shaped
