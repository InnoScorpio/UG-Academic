to setup
  ...
  let string1 (user-input "Enter number1")
  let number1 (read-from-string string1)
  show number1

  let string2 (user-input "Enter number2")
  let number2 (read-from-string string2)
  show number2
...
;The result may be a number, list, string, or boolean value, or the special value "nobody".
@#$#@#$#@
GRAPHICS-WINDOW
210
10
