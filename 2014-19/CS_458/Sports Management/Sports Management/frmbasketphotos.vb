Public Class frmbasketphotos
    ...
    Private Sub frmbasketphotos_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        opendb()
        loadgrid()
    End Sub
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        sql = "insert into tbl_basket(photo)"
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        sql = "delete from tbl_basket where photo='" & DataGridView1.CurrentRow.Cells(0).Value & "'"
        conn.Execute(sql)
