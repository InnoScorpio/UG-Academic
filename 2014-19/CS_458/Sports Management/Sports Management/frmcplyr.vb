Public Class frmcplyr

    Private Sub frmcplyr_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        opendb()
        loadgrid()
    End Sub
    Sub loadgrid()
        sql = "select * from tbl_streg where (sport = N'CRICKET')"
