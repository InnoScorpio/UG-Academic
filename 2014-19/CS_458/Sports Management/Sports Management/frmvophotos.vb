Public Class frmvophotos
    ...
    Private Sub frmvophotos_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        opendb()
        loadgrid()
    End Sub
    Sub loadgrid()
        sql = "select * from tbl_volley"
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        sql = "insert into tbl_volley(photo)"
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        sql = "delete from tbl_volley where photo='" & DataGridView1.CurrentRow.Cells(0).Value & "'"
        conn.Execute(sql)
